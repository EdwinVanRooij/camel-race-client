...
//    private final static String BACKEND_IP = "192.168.178.37 ";
//    private final static String BACKEND_IP = "192.168.5.131";
    private final static String BACKEND_IP = "88.159.34.253";
